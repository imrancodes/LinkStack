  ...
  return (
    <nav className='flex items-center justify-between bg-[#191919d4] mx-4 mt-6 min-[800px]:mb-8 mb-6 p-4 rounded-lg'>
        ...
        <div className='flex gap-6 text-lg font-semibold'>
          ...
          <NavLink className={({isActive}) =>`flex gap-2 items-center justify-center rounded-lg ${isActive ? 'text-[#633CFF] bg-[#633cff36] px-4 py-3' : 'text-white bg-transparent px-0 py-0'} `} to={'/profile'} title='profile'>
            <CgProfile className='text-xl' />
            <h1 className='max-[800px]:hidden'>Profile Details</h1>
          </NavLink>
        </div>
        <div className='flex'>
          <Link to={'/preview'} className='px-5 py-3 border border-[#633CFF] rounded-lg font-semibold hover:bg-[#633cff26]'>
